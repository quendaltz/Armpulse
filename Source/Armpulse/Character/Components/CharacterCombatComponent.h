...
public:	
	...
	void Attack(UCharacterStatusComponent* CharacterStatusComponent, FCollisionShape AttackHitbox, FRotator AttackRotation, FVector HitboxSpawnLocation, float ProcessAttackAfterAnimationTime = 0.0f);
